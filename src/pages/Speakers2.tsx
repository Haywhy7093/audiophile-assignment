    ...
    <main className="max-w-7xl mx-auto px-6 py-12 text-black">
      ...
      <section className="grid md:grid-cols-2 gap-12 items-center mb-24">
        ...
        <div>
          ...
          <p className="font-bold text-lg mb-6">$ 3500</p>
      ...
      <section className="grid md:grid-cols-2 gap-16 mb-24">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>
              <span className="text-orange-400 font-bold mr-4">1x</span> 3.5mm 7.5m Audio Cable
            </li>
            <li>
              <span className="text-orange-400 font-bold mr-4">1x</span> 7.5m Optical Cable
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-2 mb-12 px-6 md:px-12 py-12">
        <div className="grid gap-2">
          <img src={No1} alt="Beat" className="rounded-xl" />
          <img src={No2} alt="Desk" className="rounded-xl" />
        </div>
        <img src={No3} alt="Speakers" className="rounded-xl" />
      </section>
